  ...
  object ZQuery1: TZQuery
    ...
    SQL.Strings = (
      ...
      '       banda, '
        ...
        #9'     replace(concat(rtrim(class_rastr), '#39'-'#39', rtrim(class_rastr2' +
        '), '#39'-'#39', rtrim(class_rastr3), '#39'-'#39', rtrim(class_rastr4), '#39'-'#39', rtri' +
        'm(class_rastr5), '#39'-'#39', rtrim(class_rastr6)),'#39'--'#39','#39#39') as rastr,'
      '       num_lote,'
      '       data_pes,'
      '       cod_tras'
    ...
    object ZQuery1rastr: TWideStringField
      Alignment = taCenter
      FieldName = 'rastr'
      ReadOnly = True
      Size = 255
  ...
  object ZQuery2: TZQuery
    ...
    SQL.Strings = (
      ...
      #9'     clas.cod_matur,'
        ...
        #9'     replace(concat(rtrim(ras.class_rastr), '#39'-'#39', rtrim(ras.clas' +
        's_rastr2), '#39'-'#39', rtrim(ras.class_rastr3), '#39'-'#39', rtrim(ras.class_ra' +
        'str4), '#39'-'#39', rtrim(ras.class_rastr5), '#39'-'#39', rtrim(ras.class_rastr6' +
        ')),'#39'--'#39','#39#39') as rastr,'
      
        #9'     replace(concat(rtrim(clas.class_rastr), '#39'-'#39', rtrim(clas.cl' +
        'ass_rastr2), '#39'-'#39', rtrim(clas.class_rastr3), '#39'-'#39', rtrim(clas.clas' +
        's_rastr4), '#39'-'#39', rtrim(clas.class_rastr5), '#39'-'#39', rtrim(clas.class_' +
        'rastr6)),'#39'--'#39','#39#39') as class,'
      #9'     ras.cod_rastr,'
      #9'     dia.cod_rastr'
    ...
    object ZQuery2rastr: TWideStringField
      Alignment = taCenter
      FieldName = 'rastr'
      ReadOnly = True
      Size = 255
    end
    object ZQuery2class: TWideStringField
      Alignment = taCenter
      FieldName = 'class'
      ReadOnly = True
      Size = 255
  ...
  object ZQuery6: TZQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'select replace(concat(rtrim(class_rastr), '#39'-'#39', rtrim(class_rastr' +
        '2), '#39'-'#39', rtrim(class_rastr3), '#39'-'#39', rtrim(class_rastr4), '#39'-'#39', rtr' +
        'im(class_rastr5), '#39'-'#39', rtrim(class_rastr6)),'#39'--'#39','#39#39') as rastr,'
      '       count(1)/2 as quant'
      '  from t_pescarcaca'
      ' where data_abate = @data'
      
        ' group by replace(concat(rtrim(class_rastr), '#39'-'#39', rtrim(class_ra' +
        'str2), '#39'-'#39', rtrim(class_rastr3), '#39'-'#39', rtrim(class_rastr4), '#39'-'#39', ' +
        'rtrim(class_rastr5), '#39'-'#39', rtrim(class_rastr6)),'#39'--'#39','#39#39')'
      
        ' order by replace(concat(rtrim(class_rastr), '#39'-'#39', rtrim(class_ra' +
        'str2), '#39'-'#39', rtrim(class_rastr3), '#39'-'#39', rtrim(class_rastr4), '#39'-'#39', ' +
        'rtrim(class_rastr5), '#39'-'#39', rtrim(class_rastr6)),'#39'--'#39','#39#39')'
      '')
    Params = <>
  ...
  object ZQuery7: TZQuery
    ...
    SQL.Strings = (
      ...
      'select pes.cod_camara,'
        ...
        '       replace(concat(rtrim(pes.class_rastr), '#39'-'#39', rtrim(pes.cla' +
        'ss_rastr2), '#39'-'#39', rtrim(pes.class_rastr3), '#39'-'#39', rtrim(pes.class_r' +
        'astr4), '#39'-'#39', rtrim(pes.class_rastr5), '#39'-'#39', rtrim(pes.class_rastr' +
        '6)),'#39'--'#39','#39#39') as rastr,'
      ...
      '   and pes.cod_camara <> '#39#39
        ...
        ' '#39'-'#39', rtrim(pes.class_rastr2), '#39'-'#39', rtrim(pes.class_rastr3), '#39'-'#39 +
        ', rtrim(pes.class_rastr4), '#39'-'#39', rtrim(pes.class_rastr5), '#39'-'#39', rt' +
        'rim(pes.class_rastr6)),'#39'--'#39','#39#39')'
      
        ' order by pes.cod_camara, replace(concat(rtrim(pes.class_rastr),' +
        ' '#39'-'#39', rtrim(pes.class_rastr2), '#39'-'#39', rtrim(pes.class_rastr3), '#39'-'#39 +
        ', rtrim(pes.class_rastr4), '#39'-'#39', rtrim(pes.class_rastr5), '#39'-'#39', rt' +
        'rim(pes.class_rastr6)),'#39'--'#39','#39#39')'
      ''
    ...
    object ZQuery7rastr: TWideStringField
      Alignment = taCenter
      FieldName = 'rastr'
      ReadOnly = True
      Size = 255
  ...
  object ZQuery8: TZQuery
    ...
    SQL.Strings = (
      ...
      #9'     cam.cod_trilho,'
        ...
        '  '#9'   replace(concat(rtrim(pes.class_rastr), '#39'-'#39', rtrim(pes.clas' +
        's_rastr2), '#39'-'#39', rtrim(pes.class_rastr3), '#39'-'#39', rtrim(pes.class_ra' +
        'str4), '#39'-'#39', rtrim(pes.class_rastr5), '#39'-'#39', rtrim(pes.class_rastr6' +
        ')),'#39'--'#39','#39#39') as rastr,'
      '       pes.num_lote,'
    ...
    object ZQuery8rastr: TWideStringField
      Alignment = taCenter
      FieldName = 'rastr'
      ReadOnly = True
      Size = 255
  ...
  object ZQuery11: TZQuery
    ...
    SQL.Strings = (
      ...
      'select num_lote,'
        ...
        '       replace(concat(rtrim(class_rastr), '#39'-'#39', rtrim(class_rastr' +
        '2), '#39'-'#39', rtrim(class_rastr3), '#39'-'#39', rtrim(class_rastr4), '#39'-'#39', rtr' +
        'im(class_rastr5), '#39'-'#39', rtrim(class_rastr6)),'#39'--'#39','#39#39') as rastr,'
      '       count(1)/2 as quant'
      '  from t_pescarcaca'
      ' where data_abate = @data'
        ...
        ' group by num_lote, replace(concat(rtrim(class_rastr), '#39'-'#39', rtri' +
        'm(class_rastr2), '#39'-'#39', rtrim(class_rastr3), '#39'-'#39', rtrim(class_rast' +
        'r4), '#39'-'#39', rtrim(class_rastr5), '#39'-'#39', rtrim(class_rastr6)),'#39'--'#39','#39#39 +
        ')'
    ...
    object ZQuery11rastr: TWideStringField
      Alignment = taCenter
      FieldName = 'rastr'
      ReadOnly = True
      Size = 255
