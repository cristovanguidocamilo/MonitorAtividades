  ...
  object DBGrid2: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'rastr'
        Title.Alignment = taCenter
        Title.Caption = 'Habilita'#231#227'o R'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clMaroon
        Title.Font.Height = -11
        Title.Font.Name = 'Tahoma'
      ...
      item
        ...
        FieldName = 'class'
        Title.Alignment = taCenter
        Title.Caption = 'Habilita'#231#227'o C'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clMaroon
        Title.Font.Height = -11
        Title.Font.Name = 'Tahoma'
  ...
  object ZQuery2: TZQuery
    ...
    SQL.Strings = (
      ...
      '       t.cod_matur,'
        ...
        '       case when (substring(t.class,len(t.class),1)) = '#39'-'#39' then ' +
        'substring(t.class, 1, len(t.class)-1) else t.class end as class,'
      '       t.cod_rastr,'
      '       t.dia as cod_rastr'
      '  from ('
      ...
      #9'     clas.cod_matur,'
        ...
        #9'     replace(concat(rtrim(ras.class_rastr), rtrim('#39'-'#39'+ras.class' +
        '_rastr2), rtrim('#39'-'#39'+ras.class_rastr3), rtrim('#39'-'#39'+ras.class_rastr' +
        '4), rtrim('#39'-'#39'+ras.class_rastr5), rtrim('#39'-'#39'+ras.class_rastr6)),'#39'-' +
        '-'#39','#39#39') as rastr,'
      
        #9'     replace(concat(rtrim(clas.class_rastr), rtrim('#39'-'#39'+clas.cla' +
        'ss_rastr2), rtrim('#39'-'#39'+clas.class_rastr3), rtrim('#39'-'#39'+clas.class_r' +
        'astr4), rtrim('#39'-'#39'+clas.class_rastr5), rtrim('#39'-'#39'+clas.class_rastr' +
        '6)),'#39'--'#39','#39#39') as class,'
      #9'     ras.cod_rastr,'
      #9'     dia.cod_rastr as dia'
